...
const staticQuotes = [
  {
    id: "q_amandeep",
    text: /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: "Thank you for your kindness, support and dedication. You will be missed by all of us, and we wish you success and happiness in your next journey." }),
    by: "Amandeep"
  },
  {
    id: "q_vineet",
  ...
  {
    id: "q3",
    text: /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: "Working with Pavitra Ma’am has been one of the most valuable parts of my journey at RPS. Whether it was the times I needed guidance or moments when I felt frustrated, she always supported me with patience and positivity. Apart from Shiv Sir, Pavitra Ma’am has been one of the people who truly mentored and helped shape me professionally into who I am today, and I will always be grateful for that. Wishing you all the happiness and success for your new journey. Please keep spreading the positivity that makes you so special. RPS will never be the same without you." }),
    by: "Vishal"
  },
  {
    id: "q4",
    text: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-gold-bright block mb-2 font-display text-sm tracking-widest", children: "★ AN ODE TO PAVITRA ★" }),
      "You answered every question,",
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      "You rescued every file,",
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      "You brightened up the office,",
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      "With your patience and your smile.",
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      "No panic when the servers crashed,",
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      "No problem too acute,",
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      "You guided us through busy days,",
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      "A highly skilled recruit.",
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      "Now you are trading spreadsheets,",
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      "For a kitchen by the sea,",
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      "To brew the perfect morning cup,",
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      "And roast the coffee bean.",
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      "Farewell to our great coworker,",
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      "As you start this sweet café,",
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      "We wish you endless sunny skies,",
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
...
function Finale() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative py-24 px-6 md:px-12 bg-poster film-grain overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto text-center relative", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-ivory/90 text-lg md:text-xl leading-relaxed", children: "Even though you are moving on to your next big adventure, your story here will always be our favorite. As you start this beautiful new chapter, may your path be blessed with endless peace and joy. We will miss you deeply but we know the magic is far from over." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-10 font-poster tracking-[0.5em] text-gold/40 text-xs", children: "★ HAPPY BEGINNINGS ✨ ★" })
  ] }) });
}
